    ...
    (w.fn.prettyPhoto = function (e) {
      ...
      function c() {
        w(".pp_loaderIcon").hide(),
          (projectedTop =
            scroll_pos.scrollTop + (d / 2 - i.containerHeight / 2)) < 0 &&
            (projectedTop = 0),
            ...
            ? ((itemWidth = 57),
              ...
              (itemsPerPage =
                (itemsPerPage = Math.floor(
                  ...
                  ? itemsPerPage
                  : pp_images.length),
              0 == (totalPage = Math.ceil(pp_images.length / itemsPerPage) - 1)
                ? ((navWidth = 0),
      ...
      function m(t, e) {
        (t = parseFloat(t)),
          (e = parseFloat(e)),
          ($pp_details = $pp_pic_holder.find(".pp_details")).width(t),
          (detailsHeight =
          ...
          (detailsHeight =
            (detailsHeight += $pp_details.height()) <= 34 ? 36 : detailsHeight),
          $pp_details.remove(),
          ($pp_title = $pp_pic_holder.find(".ppt")).width(t),
          (titleHeight =
      ...
      return (
          ...
          return (
            ...
            $pp_pic_holder.fadeIn(function () {
              switch (
                      ...
                      0 <
                        (movie_id =
                          ...
                          (movie_id = (movie_id =
                            ...
                            ? movie_id.substr(0, movie_id.indexOf("?"))
                            : movie_id).indexOf("&") &&
                ...
                case "vimeo":
                  i = g(movie_width, movie_height);
                  var t = (movie_id = pp_images[set_position]).match(
                ...
                case "flash":
                  (i = g(movie_width, movie_height)),
                    (flash_vars = (flash_vars =
                      pp_images[set_position]).substring(
                      pp_images[set_position].indexOf("flashvars") + 10,
                      pp_images[set_position].length
                    )),
                    (filename = (filename = pp_images[set_position]).substring(
                      0,
                      filename.indexOf("?")
                    )),
                ...
                case "iframe":
                  (i = g(movie_width, movie_height)),
                    (frame_url = (frame_url = pp_images[set_position]).substr(
                      0,
        ...
        !pp_alreadyInitialized &&
          ...
          (hashIndex = b()),
          (hashIndex = (hashRel = hashIndex).substring(
            hashIndex.indexOf("/") + 1,
            hashIndex.length - 1
          )),
