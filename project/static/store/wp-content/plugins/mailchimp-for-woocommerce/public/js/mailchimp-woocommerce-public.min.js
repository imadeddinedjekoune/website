...
function mailchimpGetCurrentUserByHash(e) {
  try {
    ...
    var i =
        mailchimp_public_data.ajax_url +
        "?action=mailchimp_get_user_by_hash&hash=" +
        e,
    ...
    a.open("POST", i, !0),
      (a.onload = function () {
        if (a.status >= 200 && a.status < 400) {
          ...
          if (!e) return;
          mailchimp_cart.valueEmail(e.email) &&
            mailchimp_cart.setEmail(e.email);
        }
      }),
      (a.onerror = function () {
        console.log(
          "mailchimp.get_email_by_hash.request.error",
          a.responseText
        );
      }),
...
function mailchimpHandleBillingEmail(e) {
  try {
    ...
    var a = document.querySelector(e),
      t = void 0 !== a ? a.value : "";
    if (!mailchimp_cart.valueEmail(t) || mailchimp_submitted_email === t)
      return !1;
    mailchimp_cart.setEmail(t);
    var l =
        mailchimp_public_data.ajax_url +
        "?action=mailchimp_set_user_by_email&email=" +
        t +
        "&mc_language=" +
...
!(function () {
  ...
  var e,
          ...
          for (var t in (i = e.split("&"))) {
            ...
            if ("string" == typeof l) {
              var m = l.split("="),
                n = m[0],
                r = m[1];
              n.length && (void 0 === a[n] && (a[n] = []), a[n].push(r));
            }
          }
        return a;
      },
    ...
    l =
      ...
      (a.get = function (i, t) {
        return (
          e.cookie !== a._cacheString && a._populateCache(),
          null == a._cache[i] ? t : a._cache[i]
        );
      }),
      (a.defaults = { path: "/", secure: !0, samesite: "strict" }),
      (a.set = function (t, l, m) {
        switch (
          ((m = {
            path: (m && m.path) || a.defaults.path,
            domain: (m && m.domain) || a.defaults.domain,
            expires: (m && m.expires) || a.defaults.expires,
            secure: m && m.secure !== i ? m.secure : a.defaults.secure,
            samesite: (m && m.samesite) || a.defaults.samesite,
          }),
          l === i && (m.expires = -1),
          typeof m.expires)
        ) {
          case "number":
            m.expires = new Date(new Date().getTime() + 1e3 * m.expires);
            break;
          case "string":
        ...
        return (
          ...
          (t += m.path ? ";path=" + m.path : ""),
          (t += m.domain ? ";domain=" + m.domain : ""),
          (t += m.expires ? ";expires=" + m.expires.toGMTString() : ""),
          (t += m.secure ? ";secure" : ""),
          (t += m.samesite ? ";samesite=" + m.samesite : ""),
          (e.cookie = t),
          a
        );
      }),
      ...
      (a._populateCache = function () {
        ...
        try {
          ...
          for (var t = a._cacheString.split("; "), l = 0; l < t.length; l++) {
            var m = t[l].indexOf("="),
              n = decodeURIComponent(t[l].substr(0, m));
            (m = decodeURIComponent(t[l].substr(m + 1))),
              a._cache[n] === i && (a._cache[n] = m);
          }
        } catch (e) {
          console.log(e);
        }
    ...
    (mailchimp_cart = new (function () {
      return (
        ...
        (this.expireUser = function () {
          (this.current_email = null),
            mailchimp_public_data.allowed_to_set_cookies &&
        ...
        (this.setEmail = function (e) {
          if (mailchimp_public_data.allowed_to_set_cookies) {
            ...
            this.setPreviousEmail(this.getEmail()),
              mailchimp.storage.set(
                "mailchimp.cart.current_email",
                (this.current_email = e)
              );
          }
        }),
        ...
        (this.setPreviousEmail = function (e) {
          if (mailchimp_public_data.allowed_to_set_cookies)
            return (
              !!this.valueEmail(e) &&
              void mailchimp.storage.set(
                "mailchimp.cart.previous_email",
                (this.previous_email = e)
              )
            );
        }),
  ...
  mailchimpReady(function () {
    if (
      mailchimp_public_data.allowed_to_set_cookies &&
      !mailchimp_public_data.disable_carts
    ) {
      if (void 0 === e)
        var e = {
      ...
      try {
        ...
        var a = document.querySelector("#mailchimp_woocommerce_newsletter");
        a &&
          (a.onchange = function () {
